...
class IngestionWorker:
    ...
    def process_package(self, zip_path: Path, university_id: str, author_id: str, program_name: str = None, title_override: Optional[str] = None) -> Dict[str, Any]:
        """
